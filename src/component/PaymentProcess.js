            ...
            <>
              ...
              <Modal.Body className="payment-process">
                <p>
                  ...
                  {cryptoAmount?.amount ? cryptoAmount?.amount : ""} Token.
                </p>
                <p className="mb-0">
                        ...
                        >
                          <div
                            className={`form-check-input ${
                              paymentOption === "bankTransfer" ? "checked" : ""
                            }`}
                          />
                ...
                >
                  <div
                    className={`form-check-input ${
                      isTermsSelected === true ? "checked" : ""
                    }`}
                  />
                  <label class="form-check-label">
                  I hereby agree to the token purchase agreement and token sale term.
                  </label>
                </div>
